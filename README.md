<p align="center">
  <img src="assets/mathstep-banner.jpg" alt="MathStep · Ascending Learning" width="820">
</p>

<h1 align="center">MathStep</h1>
<p align="center"><b>Ascending Learning</b> · Aprendizaje que asciende</p>

<p align="center">
  <a href="https://ttonguinon.github.io/mathstep/"><b>🚀 Abrir la app</b></a> ·
  <a href="https://ttonguinon.github.io/mathstep/demo.html">Demostración</a> ·
  <a href="https://ttonguinon.github.io/mathstep/presentacion.html">Presentación (2 min)</a> ·
  <a href="https://ttonguinon.github.io/mathstep/presentation.html">Presentation (EN, 2 min)</a> ·
  <a href="https://ttonguinon.github.io/mathstep/introduccion.html">Video (1 min)</a> ·
  <a href="https://ttonguinon.github.io/mathstep/intro.html">Intro video (EN)</a>
</p>

---

**MathStep** es una aplicación web para aprender matemáticas de **1.º a 11.º grado**, paso a paso y al ritmo de cada estudiante. Funciona en el navegador de cualquier celular o computador, se puede instalar como aplicación, trabaja sin conexión y no tiene publicidad.

<p align="center"><img src="assets/capturas.jpg" alt="Capturas de MathStep" width="820"></p>
...
| `marca/` | Logos de MathStep (SVG y PNG) |
...
3. En uno o dos minutos la app queda en `https://ttonguinon.github.io/mathstep/`.
...
Si cambias los íconos o `sw.js`, sube el número de versión dentro de `sw.js` (`mathstep-v1` → `mathstep-v2`).
...
© 2026 Thommy Alcides Tonguino Noronha · MathStep. Todos los derechos reservados. Consulta [LICENSE.md](LICENSE.md).
