# MathStep: instalación de la nube en Google Sheets
...
2. Ponle un nombre, por ejemplo **MathStep – Base de datos**.
...
```
{"ok":true,"app":"MathStep","mensaje":"Servidor activo"}
```
...
Al abrir la hoja aparece el menú **MathStep**. Si no lo ves, recarga la página.
...
| No aparece el menú MathStep | Recarga la hoja. Si sigue sin aparecer, ejecuta **configurar** otra vez desde Apps Script. |
